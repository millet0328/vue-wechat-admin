    ...
    <div>
        ...
        <el-form ref="form" :model="form" label-position="left" label-width="120px">
            ...
            <el-form-item label="商品主图">
                <el-upload :limit="1" action="/api/upload/goods/" :file-list="mainFileList" :headers="headers"
                           list-type="picture-card"
                           :before-upload="handleBeforeUpload"
                           :on-success="handleMainSuccess" :before-remove="handleMainBeforeRemove"
                           :on-exceed="handleMainExceed" :on-error="handleError"
            ...
            <el-form-item label="商品轮播图">
                <el-upload :limit="6" action="/api/upload/slider/" :file-list="sliderFileList" :headers="headers"
                           list-type="picture-card"
                           :before-upload="handleBeforeUpload"
    ...
    export default {
        ...
        methods: {
            ...
            async handleMainBeforeRemove(file, fileList) {
                try {
                    let res1 = await Upload.deleteImage({src: "." + this.form.img_lg});
                    let res2 = await Upload.deleteImage({src: "." + this.form.img_md});
